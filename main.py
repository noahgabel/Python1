...
2. Transform: Filter only Iris-setosa species using PySpark
...
def main():
    ...
    # =========================================================================
    print("\n" + "=" * 70)
    print("STEP 2: TRANSFORM - Filtering Iris-setosa data with PySpark")
    print("=" * 70)

    try:
        df_filtered, spark = transform_module.transform_iris_data(downloaded_file)
    except Exception as e:
    ...
    # Load to CSV
    try:
        csv_output = load_module.load_to_csv(df_filtered, OUTPUT_FOLDER, DATA_URL)
    except Exception as e:
    ...
    # Load to MySQL
    try:
        load_module.load_to_mysql(df_filtered, DB_CONFIG)
    except Exception as e:
    ...
    try:
        df_for_viz = load_module.read_from_mysql(DB_CONFIG)
    except Exception as e:
